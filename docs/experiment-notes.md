...
These are the original development notes, retained for methods and intermediate results. See the repository README for the current summary and for which evaluation scores can be compared directly.
